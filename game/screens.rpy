...
style main_menu_nav_button_text is navigation_button_text:
    font "fonts/UnifrakturMaguntia/UnifrakturMaguntia-Regular.ttf"
    size 50
...
image fire_particles = Movie(
    play="video/fire_particles.webm",
    loop=True,
    size=(1920, 1080)
)

transform fire_overlay_fade:
    alpha 0.0
    linear 2.0 alpha 0.45
    pause 9.0
    repeat
...
screen main_menu():
    ...
    add Transform("fire_particles", blend="add") at fire_overlay_fade
